...
uses
  Classes, SysUtils, Graphics, ExtCtrls, Math, MemoryPix;
...
//  decal : longint ;
//begin
//    LineWidth := Image.Picture.Bitmap.RawImage.Description.BytesPerLine ;
//    PixelWidth := Image.Picture.Bitmap.RawImage.Description.BitsPerPixel div 8 ;
//    ScanLine := Image.Picture.Bitmap.RawImage.Data;
//    inc(ScanLine, LineWidth * y + PixelWidth * x);
//    Color := TColor(0);
//    decal:=1;
//    for j:=2 downto 0 do
//      begin
//        Color := Color + ((ScanLine+j)^) * decal;
//        //Color := Color + (ScanLine^)*decal;
//        decal := decal * 256;
//      end;
//    GetPixelColor := Color;
//end;

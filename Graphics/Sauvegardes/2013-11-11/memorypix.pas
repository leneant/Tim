...
type
  ...
  TListPixels = class(TObject)
    ...
    public
      ...
      procedure getImageFromTImage (var Image : TImage);
      procedure drawTeinteIntoTImage(var Teinte : TAncrePixels;var Image : TImage; _draw : boolean; sat, lum : integer; waitingbox : boolean);
  end;
...
procedure TListPixels.drawTeinteIntoTImage(var Teinte : TAncrePixels; var Image : TImage; _draw : boolean; sat, lum : integer; waitingbox : boolean);
...
begin
  ...
  for i := 0 to self._height - 1 do begin
      ...
      if (y mod 10 = 0) then ProgressWindow.setProgressInc(y/self._height*100);
  end;
end;

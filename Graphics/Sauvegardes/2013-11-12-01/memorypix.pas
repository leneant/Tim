...
type
  ...
  TListPixels = class(TObject)
    ...
    public
      ...
      procedure getImageFromTImage (var Image : TImage);
      procedure drawTeinteIntoTImage(var Teinte : TAncrePixels;var Image : TImage; _draw : boolean; sat, lum : integer; waitingbox : boolean; wboxpercent : integer);
  end;
...
procedure TListPixels.drawTeinteIntoTImage(var Teinte : TAncrePixels; var Image : TImage; _draw : boolean; sat, lum : integer; waitingbox : boolean; wboxpercent : integer);
